...
- การเพิ่ม layer ทำให้เรียนรู้ไปเรื่อย ๆ ตอบได้ 100%
	แต่มันจะเกิดปัญหา overfiting
Input layer = feature + 1
hidden layer = ยิ่งมีเยอะ ยิ่งเเก้ปัญหาได้เยอะ
เวลาดูว่า model ทำงานได้ดีมั้ย 
...
2. **convolutional layers** > weight จะถูกรวมอยู่ในตารางเล็ก ๆ
   ...
   <img src="![image](https://github.com/user-attachments/assets/7e95a415-5c3c-43da-81ab-927a6ecfdd9c)" width="40%">

**Convolutional Neural Networks (CNN)**

   <img src="![image](https://github.com/user-attachments/assets/98c70796-9c77-4a91-bf83-65ca02962249)" width="40%">

**histogram of gradients**

   <img src="![image](https://github.com/user-attachments/assets/c3fa5f03-b98d-4461-94c5-1f57a5d81a5b)" width="40%">
...
การป้องกันปัญหา overfit ด้วย dropout 
  ...
  <img src="![image](https://github.com/user-attachments/assets/bd2234df-3a9a-4f40-9a43-bcc2e7803091)" width="40%">
